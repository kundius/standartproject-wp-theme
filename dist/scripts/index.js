...
(function () {
  ...
  var showFocus = function showFocus() {
    body.classList.remove('ui-focus-disabled');
  };

  var hideFocus = function hideFocus() {
    body.classList.add('ui-focus-disabled');
  };

  var handleTabPress = function handleTabPress(e) {
    if (e.which == 27) {
      hideFocus();
    }
...
(function () {
  ...
  var nextButtons = drawer.querySelectorAll('[data-next]');

  var _loop = function _loop(i) {
    var arrow = nextButtons[i];
    arrow.addEventListener('click', function () {
      var drawerParents = drawer.querySelectorAll("[data-parent]");

      if (drawerParents) {
        for (var k = 0; k < drawerParents.length; k++) {
          var drawerParent = drawerParents[k];
      ...
      drawer.querySelector("[data-parent=\"".concat(arrow.dataset.next, "\"]")).classList.add('drawer-screen_opened');
    });
  };
...
var scrolltop = document.querySelector('.ui-scrolltop');
